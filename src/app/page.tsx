...
const pastEvents = [
  {
    ...
    venue: "Kottoor",
    image: "/sslc.jpg",
    description: "Honoring our bright students for their academic excellence."
  }
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-primary rounded-[5rem] p-12 md:p-32 shadow-2xl flex flex-col lg:grid lg:grid-cols-2 gap-24 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white p-12 md:p-16 rounded-[4rem] shadow-2xl">
              <form onSubmit={(e) => { e.preventDefault(); setFormStatus("Transmitting..."); setTimeout(() => setFormStatus("Transmitted!"), 1000); }} className="space-y-10">
